...
<div class="form-group {{ $errors->has('order_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="order_id" type="number" id="order_id" value="{{ isset($payment->order_id) ? $payment->order_id : request('order_id')}}" >
...
<div class="form-group">
    <input class="btn btn-primary" type="submit" value="{{ $formMode === 'edit' ? 'Update' : 'Create' }}"readonly>
</div>
